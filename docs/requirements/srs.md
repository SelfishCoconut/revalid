...
- **Acceptance criteria — scope-driven sandbox target** (met — issue #208, ADR-0041 proposed, 2026-07-24):
...
- **Traces to**: issue #136, ADR-0036 (accepted) + ADR-0038 (streaming; shipped on `main` in PR #168, ADR still `proposed` pending ratification), milestone M6.
