...
- **Deferred to Slice 6b-ii/6b-iii** (tracked in epic #87): user-owned goal seeded by a repurposed FR-04 (6b-ii); retirement of the batch *execution* path + SPA finding-flow reshape (6b-iii). Kali-tooling sandbox image tracked separately (#105).
