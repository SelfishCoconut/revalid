...
- **Done when**: the real Juice Shop PDF report yields ≥90% well-formed findings (FR-03 criterion — **met: 8/8 on a local model**); release `v0.2.0` after ADR ratification.
