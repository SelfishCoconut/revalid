...
- The thesis AI declaration is generated by the `ai-declaration` skill. AI-usage compliance (§6) is Álvaro's own responsibility — he reviews it directly, not via an agent (ADR-0005). Run the `codebase-sanity` agent before each milestone release.
