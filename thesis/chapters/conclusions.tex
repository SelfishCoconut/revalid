...
with the deliberate decision to keep the per-command gate as the default, on the
reasoning that a modest overhead is the cheaper thing to carry than an unaudited
command.
