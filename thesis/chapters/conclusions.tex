...
capability of the model behind it. That the gate in those runs was exercised
programmatically rather than by a person is stated where the results are
(Section~\ref{sec:eval-threats}), and validating it with human operators is the first
item of the wider study. This closing chapter steps back from the artefact
...
autonomous agent produces --- but the seat holding that authority was filled
programmatically and knew the expected verdicts
