...
shows is that the safety of the result rests on the human gate rather than on the
capability of the model behind it. This closing chapter steps back from the artefact
