...
with the evaluation's most useful practical finding, that the human gate cost
essentially no time (Section~\ref{sec:eval-time}), so the safety property is not one
an operator has to pay for.
