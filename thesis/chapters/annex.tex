...
\item \textbf{Docker}, used to bring up the intentionally vulnerable lab target the
  retest agent exercises.
...
Retests only ever reach allow-listed lab systems (FR-06); the agent's commands run
inside an egress-locked sandbox that can reach the lab container and nothing else.
