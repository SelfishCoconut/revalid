...
network. (A scope naming a host outside the lab instead provisions a per-session
proxy that permits that host alone; if it cannot be provisioned the session is torn
down rather than run unrestricted.) Two practical consequences follow for the lab
case, both worth knowing before the first run.
