...
% Chapters open on a recto page, so LaTeX inserts a filler verso before each one.
% Leave those fillers genuinely blank: a page carrying only a number and a running
% head reads as a printing defect.
\makeatletter
...
% Start the bibliography on a recto page (the filler verso stays blank, see above).
\cleardoublepage
