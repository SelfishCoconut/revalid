...
% -------------------------------
% Diagramas vectoriales (TikZ) para figuras originales
% -------------------------------
\usepackage{tikz}
...
% -------------------------------
\usepackage{hyperref}
% Production-ready links: clickable but with no coloured boxes or borders around
% citations, cross-references or URLs (hidelinks removes both the frame and the tint).
...
% Widen the ToC/LoF/LoT page-number box: the memoir passed 100 pages, and the
% default \@pnumwidth is too narrow for a bold three-digit number, which otherwise
% overfills its box by a few points in the contents.
...
% Palabras clave
\renewcommand{\algorithmicrepeat}{\bft{repeat}}
\renewcommand{\algorithmicuntil}{\bft{until}}
\renewcommand{\algorithmicend}{\bft{end}}
\renewcommand{\algorithmicif}{\bft{if}}
\renewcommand{\algorithmicthen}{\bft{then}}
\renewcommand{\algorithmicelse}{\bft{else}}
\newcommand{\algorithmicelsif}{\algorithmicelse\ \algorithmicif}
\newcommand{\algorithmicendif}{\algorithmicend\ \algorithmicif}
\renewcommand{\algorithmicfor}{\bft{for}}
\renewcommand{\algorithmicforall}{\bft{for each}}
\renewcommand{\algorithmicwhile}{\bft{while}}
\renewcommand{\algorithmicdo}{\bft{do}}
\renewcommand{\algorithmicprocedure}{\bft{procedure}}
\renewcommand{\algorithmicreturn}{\bft{return}}
\renewcommand{\algorithmicfunction}{\bft{function}}
\renewcommand{\algorithmicloop}{\bft{loop}}
